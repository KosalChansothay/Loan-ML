...
def user_input_features():
    ...
    applicant_income = st.number_input('Applicant Income', min_value=0, value=0, step=1)
    coapplicant_income = st.number_input('Coapplicant Income', min_value=0, value=0, step=1)
    loan_amount = st.number_input('Loan Amount', min_value=0, value=0, step=1)
    loan_amount_term = st.number_input('Loan Amount Term (Days)', min_value=0, value=0, step=1)
...
if applicant_income <= 0:
    ...
    expected_columns = ['Credit_History', 'ApplicantIncome_log', 'CoapplicantIncome_log', 'LoanAmount_log', 'Loan_Amount_Term_log']
